...
public class ModInfo {
	public static final String ID = "NichePeripherals";
	public static final String NAME = "Niche Peripherals";
	public static final String VERSION = "0.1.0";
	public static final String CHANNEL = ID;
	public static final String DEPENDENCY = "after:ComputerCraft";
	public static final String PROXY_LOCATION = "kssr3951.nicheperipherals.system.proxy.";
}
