 ...
 */
public class EnderStorageDyeingMachineBlock extends BlockEx {

    public EnderStorageDyeingMachineBlock(Material material) {
        super(material);
    }
    ...
    {
        this.peripheralIcon = iconRegister.registerIcon(Const.TEXTURE_PREFIX + "enderStorageDyeingMachine");
    }
}
