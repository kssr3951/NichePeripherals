 ...
 */
public class BlockModemController extends BlockEx {

	public BlockModemController(Material material) {
		super(material);
	}
    ...
    {
        this.peripheralIcon = iconRegister.registerIcon(Const.TEXTURE_PREFIX + "modemController");
    }
}
