 ...
 */
public class RayTracerBlock extends BlockEx {

    public RayTracerBlock(Material material) {
        super(material);
    }
    ...
    {
        this.peripheralIcon = iconRegister.registerIcon(Const.TEXTURE_PREFIX + "rayTracer");
    }
}
