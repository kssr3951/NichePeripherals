 ...
 */
public class SclClientBlock extends BlockEx {

    public SclClientBlock(Material material) {
        super(material);
    }
    ...
    {
        this.peripheralIcon = iconRegister.registerIcon(Const.TEXTURE_PREFIX + "sclClient");
    }
}
